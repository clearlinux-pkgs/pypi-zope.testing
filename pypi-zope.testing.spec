...
Version  : 5.1
Release  : 72
URL      : https://files.pythonhosted.org/packages/29/c5/54c30f2ed34ef420733e9df9d71d0b423e384f42a5787f0ae1c70c1115b8/zope_testing-5.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/29/c5/54c30f2ed34ef420733e9df9d71d0b423e384f42a5787f0ae1c70c1115b8/zope_testing-5.1.tar.gz
...
%prep
%setup -q -n zope_testing-5.1
cd %{_builddir}/zope_testing-5.1
pushd ..
cp -a zope_testing-5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739545126
...
cp %{_builddir}/zope_testing-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-zope.testing/a0b53f43aab58b46bf79ba756c50771c605ab4c5 || :
